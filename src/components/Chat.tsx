...
const Chat = ({ chatWith }) => {
  ...
  return (
    <div className="flex flex-col items-center h-full">
      ...
      <div className="flex-1 border-2 max-h-[60vh] min-h-[60vh] min-w-[80vh] max-w-[80v] bg-white text-dark overflow-y-auto p-4 rounded-lg">
      ...
      <form onSubmit={send} className="flex min-w-full text-dark mt-4">
        <input
          type="text"
          value={newMessage}
