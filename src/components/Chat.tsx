...
// import { pollMessages } from "@/services/api";
...
const Chat = ({ chatWith }) => {
  ...
  const sendMessage = (e) => {
    e.preventDefault();
    if (newMessage.trim()) {
      // TBD - Implement sendMessage function
  ...
  return (
    <div className="flex flex-col items-center h-full">
      ...
      <div className="flex-1 border-2 max-h-[60vh] min-h-[60vh] min-w-[80vh] max-w-[80v] bg-white text-dark overflow-y-auto p-4 bg-gray-100 rounded-lg">
      ...
      <form onSubmit={sendMessage} className="flex min-w-full text-dark mt-4">
        <input
          type="text"
          value={newMessage}
        ...
        <button
          type="submit"
          className="bg-yellow-400 text-gray-600 p-2 m-1 rounded-xl  shadow-neutral-800 shadow-sm"
        >
